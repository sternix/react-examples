...
const colors = [
    ...
    constants.COLOR_OLIVE,
    constants.COLOR_GREEN,
    constants.COLOR_TEAL,
    constants.COLOR_BLUE,
    constants.COLOR_VIOLOET,
...
function DrawingModal({ open, dismiss, confirm, drawing }) {
    ...
    const [stroke, setStroke] = useState(constants.COLOR_BLACK);
    ...
    const resetDrawingBoard = () => {
        ...
        setMaxY(0);
        setStrokeWidth(5);
        setStroke(constants.COLOR_BLACK);
    };
